...
ActiveRecord::Schema.define(version: 20200107040856) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "monster_abilities", id: :serial, force: :cascade do |t|
  ...
  create_table "monster_sets", id: :serial, force: :cascade do |t|
    t.string "system"
    t.string "source"
    t.text "desc"
    t.datetime "created_at", null: false
  ...
  create_table "quirk_categories", id: :serial, force: :cascade do |t|
  ...
  create_table "quirks", id: :serial, force: :cascade do |t|
